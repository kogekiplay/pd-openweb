 ...
 *     node tools/verify-cm6-tagmarks.ts
 *
 * CM5 删掉之后参照物就没了，所以带 --write-fixture 跑一次把结果冻结下来
 *（和 verify-cm6-formulamarks.ts 同一套办法）：
 *   JSDOM_PATH=... node tools/verify-cm6-tagmarks.ts --write-fixture
 */
const fs = require('fs');
    ...
    JSON.stringify(
      {
        _note:
          ...
          '「新的 offset 换算与 CM5 的 line/ch 逐字等价」。重新生成方式见 tools/verify-cm6-tagmarks.ts 文件头。',
