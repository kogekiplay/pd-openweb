 ...
 *
 * 【2026-09-21 起基线是 0】全仓映射已经做完（9308 -> 0，分七批）。
 * 所以这个棘轮从"追进度"变成了纯粹的"防回潮"：
 * 任何一处新写的 `font-size: 14px` / `margin: 8px` 都会当场报警。
 * 新增代码直接写 var(--font-md) / var(--space-2)；
 * **值不在档位上就照常写字面量**，那不算账，见上面的口径说明。
 */
const fs = require('fs');
