export default {
   ...
   **/
  getActionLogs: function (args, options: ApiOptions = {}) {
   ...
   * @returns {Promise<Boolean, ErrorModel>}
   **/
  getOrgLogs: function (args, options: ApiOptions = {}) {
   ...
   * @returns {Promise<Boolean, ErrorModel>}
   **/
  getAccountDevices: function (args, options: ApiOptions = {}) {
...
浏览应用，entityId =应用id，浏览自定义页面，entityId = 页面id。其他的浏览行为 =worksheetId
  ...
  * @returns {Promise<Boolean, ErrorModel>}
  **/
  addLog: function (args, options: ApiOptions = {}) {
