export default {
   ...
   **/
  addDiscussion: function (args, options: ApiOptions = {}) {
   ...
   * @returns {Promise<Boolean, ErrorModel>}
   **/
  getDiscussions: function (args, options: ApiOptions = {}) {
   ...
   * @returns {Promise<Boolean, ErrorModel>}
   **/
  getDiscussionsCount: function (args, options: ApiOptions = {}) {
   ...
   * @returns {Promise<Boolean, ErrorModel>}
   **/
  removeDiscussion: function (args, options: ApiOptions = {}) {
   ...
   * @returns {Promise<Boolean, ErrorModel>}
   **/
  getDiscussionMsg: function (args, options: ApiOptions = {}) {
   ...
   * @returns {Promise<Boolean, ErrorModel>}
   **/
  getSourceAtts: function (args, options: ApiOptions = {}) {
