export default {
   ...
   **/
  addTwilioProvider: function (args: ApiArgs, options: ApiOptions = {}) {
   ...
   * @returns {Promise<Boolean, ErrorModel>}
   **/
  editTwilioProvider: function (args: ApiArgs, options: ApiOptions = {}) {
   ...
   * @returns {Promise<Boolean, ErrorModel>}
   **/
  removeTwilioProvider: function (args: ApiArgs, options: ApiOptions = {}) {
   ...
   * @returns {Promise<Boolean, ErrorModel>}
   **/
  getTwilioProvider: function (args: ApiArgs, options: ApiOptions = {}) {
   ...
   * @returns {Promise<Boolean, ErrorModel>}
   **/
  getTwilioProviderBaseInfo: function (args: ApiArgs, options: ApiOptions = {}) {
