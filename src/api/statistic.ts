export default {
   ...
   **/
  getUserReport: function (args: ApiArgs, options: ApiOptions = {}) {
   ...
   * @returns {Promise<Boolean, ErrorModel>}
   **/
  getPostReportByType: function (args: ApiArgs, options: ApiOptions = {}) {
   ...
   * @returns {Promise<Boolean, ErrorModel>}
   **/
  getGroupReport: function (args: ApiArgs, options: ApiOptions = {}) {
