export default {
   ...
   **/
  getAvailableMapList: function (args: ApiArgs, options: ApiOptions = {}) {
   ...
   * @returns {Promise<Boolean, ErrorModel>}
   **/
  getMapList: function (args: ApiArgs, options: ApiOptions = {}) {
   ...
   * @returns {Promise<Boolean, ErrorModel>}
   **/
  addMap: function (args: ApiArgs, options: ApiOptions = {}) {
   ...
   * @returns {Promise<Boolean, ErrorModel>}
   **/
  editMap: function (args: ApiArgs, options: ApiOptions = {}) {
   ...
   * @returns {Promise<Boolean, ErrorModel>}
   **/
  editMapStatus: function (args: ApiArgs, options: ApiOptions = {}) {
   ...
   * @returns {Promise<Boolean, ErrorModel>}
   **/
  editMapSort: function (args: ApiArgs, options: ApiOptions = {}) {
   ...
   * @returns {Promise<Boolean, ErrorModel>}
   **/
  removeMap: function (args: ApiArgs, options: ApiOptions = {}) {
