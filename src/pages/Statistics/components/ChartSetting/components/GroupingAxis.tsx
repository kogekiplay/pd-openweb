      ...
      <Menu className="chartControlMenu chartMenu">
        {timeDataList.map(item => (
          <Menu.Item
            ...
            style={{ color: item.value === split.particleSizeType ? 'var(--color-primary-text) !important' : null }}
            key={item.value}
            onClick={() => {
      ...
      <Menu className="chartControlMenu chartMenu" expandIcon={<Icon icon="arrow-right-tip" />}>
        ...
        >
          {emptyTypes.map(item => (
            <Menu.Item
              key={item.value}
              style={{ color: item.value === split.emptyType ? 'var(--color-primary-text) !important' : null }}
              onClick={() => {
