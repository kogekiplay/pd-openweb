  ...
  return type === 'source' ? (
    <div className="guideWrapper">
      <div className="guideContent">
        ...
        <p>
          {_l('更多配置项参考')}
          <a href="https://debezium.io/documentation/reference/stable/connectors/sqlserver.html" className="mLeft8">
        ...
        <p>
          ...
          <a
            href="https://nightlies.apache.org/flink/flink-cdc-docs-release-3.5/docs/connectors/flink-sources/sqlserver-cdc/"
            target="_blank"
            className="mLeft8"
          >
            {_l('查看连接器选项')}
