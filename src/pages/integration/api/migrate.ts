...
const migrate = {
   ...
   **/
  getReportingTaskStatus: function (args: ApiArgs, options?: ApiOptions) {
   ...
   * @returns {Promise<Boolean, ErrorModel>}
   **/
  findFlowIdByJobId: function (args: ApiArgs, options?: ApiOptions) {
   ...
   * @returns {Promise<Boolean, ErrorModel>}
   **/
  startReportingTask: function (args: ApiArgs, options?: ApiOptions) {
   ...
   * @returns {Promise<Boolean, ErrorModel>}
   **/
  getReportingTaskList: function (args: ApiArgs, options?: ApiOptions) {
   ...
   * @returns {Promise<Boolean, ErrorModel>}
   **/
  stopReportingTask: function (args: ApiArgs, options?: ApiOptions) {
