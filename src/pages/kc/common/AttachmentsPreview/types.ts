/**
 * AttachmentsPreview 自己的局部 store 类型。
 *
...
export type AttachmentsPreviewState = ReturnType<typeof reducer>;
/** 这个 store 没接 thunk 的类型化中间件，dispatch 收裸 action 也收 thunk 函数 */
export type AttachmentsPreviewDispatch = (action: any) => any;
export type AttachmentsPreviewGetState = () => AttachmentsPreviewState;
