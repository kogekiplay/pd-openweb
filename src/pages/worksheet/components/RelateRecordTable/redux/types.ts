...
/**
 * RelateRecordTable 的【局部】 store 状态类型。
 *
 ...
 */
export type RelateRecordTableState = ReturnType<typeof reducer>;

/** thunk 里的 dispatch。局部 store 不经 RTK，直接描述它实际支持的两种实参 */
export type RelateRecordTableDispatch = (action: any) => any;

export type RelateRecordTableGetState = () => RelateRecordTableState;
