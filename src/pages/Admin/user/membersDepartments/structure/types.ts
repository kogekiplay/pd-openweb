 ...
 */
import type reducer from './reducers/index';

export type StructureState = ReturnType<typeof reducer>;
/** 这个 store 没接 thunk 的类型化中间件，dispatch 收裸 action 也收 thunk 函数 */
export type StructureDispatch = (action: any) => any;
export type StructureGetState = () => StructureState;
