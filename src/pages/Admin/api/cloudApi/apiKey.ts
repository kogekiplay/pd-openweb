...
const apiKey = {
   ...
   **/
  keysCreate: function (args: ApiArgs, options?: ApiOptions) {
   ...
   * @returns {Promise<Boolean, ErrorModel>}
   **/
  keysDelete: function (args: ApiArgs, options?: ApiOptions) {
   ...
   * @returns {Promise<Boolean, ErrorModel>}
   **/
  keysDescriptionUpdate: function (args: ApiArgs, options?: ApiOptions) {
   ...
   * @returns {Promise<Boolean, ErrorModel>}
   **/
  keysIpWhitelistGet: function (args: ApiArgs, options?: ApiOptions) {
   ...
   * @returns {Promise<Boolean, ErrorModel>}
   **/
  keysIpWhitelistSave: function (args: ApiArgs, options?: ApiOptions) {
   ...
   * @returns {Promise<Boolean, ErrorModel>}
   **/
  keysList: function (args: ApiArgs, options?: ApiOptions) {
   ...
   * @returns {Promise<Boolean, ErrorModel>}
   **/
  keysStatusUpdate: function (args: ApiArgs, options?: ApiOptions) {
